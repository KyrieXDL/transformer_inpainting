python train.py \
    --flag 'mae_multiscale_external_fpn1d_interpolate_normpred_poolmid'\
    --phase 'train'\
    --output_dir './output/logs'\
    --model_save_path './saved_models/mae_multiscale_external_fpn1d_interpolate_normpred_poolmid'\
